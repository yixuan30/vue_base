<template>
  <div id="welcome">
    ...
    <el-row :gutter="15">
      ...
      <el-col :span="13">
        <!-- 用户信息表格 -->
        <el-card class="box-card"  style="margin-top:30px;padding:0px;">
        ...
        <el-card class="box-card" style="margin-top:100px;padding:0px;">
          <!-- 用户登入报表 -->
      ...
      <el-col :span="11">
        <div class="grid-content bg-purple">
          <el-card style="min-height:650px;margin-top:30px;margin-bottom:30px;">
            ...
            <aplayer
              ...
              :music="{
                  ...
                  pic: 'https://education-1010.oss-cn-beijing.aliyuncs.com/feng.jpg'
              }"
              :list="musicList"
            ></aplayer>
          </el-card>
...
export default {
  ...
  methods: {
    ...
    getCode() {
      ...
      w.location.href = "https://github.com/yixuan30/Vue-base";
    },
    async loadMusicList() {
...
.el-carousel__item:nth-child(2n) {
  ...
  background-image: url("https://education-1010.oss-cn-beijing.aliyuncs.com/feng.jpg");
  background-size: 100% 100%;
}

.el-carousel__item:nth-child(2n + 1) {
  background-color: #d3dce6;
  background-image: url("https://education-1010.oss-cn-beijing.aliyuncs.com/xue.jpg");
  background-size: 100% 100%;
}
</style>
